...
git_init(){
    git config --global user.name "ucarinc-infra"
    git config --global user.email Tech_inf@ucarinc.com
    git remote rm origin
    git remote add origin git@github.com:ucar-infra/gcr2dockerhub.git
    git pull
